...
-- ORA-02291: integrity constraint (MADANG.SYS_C007027) violated - parent key not found
COMMIT;

-- 테이블 레벨에서 제약조건 지정
CREATE TABLE EMP02 (
    EMPNO NUMBER(5),
    ENAME VARCHAR2(30) NOT NULL, -- 컬럼레벨에서 제약조건 설정
    JOB VARCHAR2(10),
    DEPTNO VARCHAR2(10),
...
********************/
-- EMP01 테이블의 PRIMARY KEY 삭제 : SYS_C007026
...
ALTER TABLE EMP02 DROP CONSTRAINT SYS_C007030;
...
--외래키 DISABLE 상태인 경우 : 외래키 자리에 부모 테이블에 없는 데이터 기재 가능
