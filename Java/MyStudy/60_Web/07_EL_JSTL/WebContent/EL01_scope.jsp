...
<body>
	...
	<h2>표현식(Expression) 산술연산 결과(자바의 정수타입 연산으로 정수로 나옴)</h2>
	<ul>
		<li>15 + 7 = <%=15 + 7 %></li>
		<li>15 - 7 = <%=15 - 7 %></li>
		<li>15 * 7 = <%=15 * 7 %></li>
	...
	<p>표현식은 사용 가능하지만, EL에서는 사용 못 함</p>
	<%! int globalNum = 10; %>
	<%! int localNum = 20; %>
	<ul>
	...
	<%
		...
		request.setAttribute("pc", "pageScope-컴퓨터2");
		session.setAttribute("pc", "pageScope-컴퓨터3");
		application.setAttribute("pc", "pageScope-컴퓨터4");
	%>
	<h3>scope 지정 없이 데이터 사용</h3>
	<ul>
